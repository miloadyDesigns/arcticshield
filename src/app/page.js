        ...
        <div className="xs:[80%] lg:w-[80%] mt-4 m-auto mb-12">
          ...
          <div className="flex xs:flex-col lg:flex-row mt-4 justify-center gap-2">
            ...
            >
              ...
              <h2 className="absolute bottom-6 xs:left-4 lg:left-8 text-white xs:text-2xl lg:text-4xl font-bold ">Arctic Wiper</h2>
            </div>
            <div className="xs:w-[100%] lg:w-[50%]">
              <div className="flex xs:h-[40vh] lg:h-[47%] gap-2 justify-center">
                ...
                >
                  ...
                  <h2 className="absolute bottom-6 xs:left-4 lg:left-8 text-white xs:text-2xl lg:text-4xl font-bold">Winter Gloves</h2>
                </div>
                <div
                  className="w-[50%] border relative rounded-xl overflow-hidden cursor-pointer"
                  style={{
                ...
                >
                  ...
                  <h2 className="absolute bottom-6 xs:left-4 lg:left-8 text-white xs:text-2xl lg:text-4xl font-bold">Ice Scrapers</h2>
                </div>
              </div>
              ...
              >
                ...
                <h2 className="absolute bottom-6 xs:left-4 lg:left-8 text-white xs:text-2xl lg:text-4xl font-bold">Merchandise</h2>
              </div>
